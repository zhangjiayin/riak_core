...
** Community 
In addition to the [[Riak Mailing list][lists.basho.com/mailman/listinfo/riak-users_lists.basho.com]], there is 	   also a mailing list [[dedicated to Riak Core][lists.basho.com/mailman/listinfo/riak-core_lists.basho.com]] and its use independent of Riak. 
